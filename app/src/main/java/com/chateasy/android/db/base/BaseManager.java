package com.chateasy.android.db.base;
...
import com.chateasy.android.db.interfaces.IDatabase;
import com.chateasy.android.greendao.gen.DaoMaster;
import com.chateasy.android.greendao.gen.DaoSession;
...
public abstract class BaseManager<M, K> implements IDatabase<M, K>{
    ...
    public List<M> loadPages(int page, int number){
        openReadableDb();;
        return getAbstractDao().queryBuilder().offset(page * number).limit(number).list();
    }
