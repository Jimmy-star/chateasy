...
public class ChatListViewAdapter extends BaseAdapter {
        ...
        switch (getItemViewType(i)){
            ...
            case FROM_USER_IMG:
                ...
                if(view == null){
                    ...
                    holder1.image_Msg = (BubbleImageView) view.findViewById(R.id.image_message);
                    view.setTag(holder1);
                }else{
            ...
            case TO_USER_MSG:
                ...
                if(view == null){
                    ...
                    holder3.headicon = (ImageView) view.findViewById(R.id.tb_my_user_icon);
                    holder3.chat_time = (TextView) view.findViewById(R.id.chat_time);
                    holder3.content = (GifTextView) view.findViewById(R.id.mycontent);
                    holder3.sendFailImage = (ImageView) view.findViewById(R.id.mysend_fail_img);
                    view.setTag(holder3);
                }else{
            ...
            case TO_USER_IMG:
                ...
                if(view == null){
                    ...
                    holder4.headicon = (ImageView) view.findViewById(R.id.tb_my_user_icon);
                    holder4.chat_time = (TextView) view.findViewById(R.id.chat_time);
                    holder4.sendFailImg = (ImageView) view.findViewById(R.id.mysend_fail_img);
                    holder4.image_group = (LinearLayout) view.findViewById(R.id.image_group);
                    holder4.image_Msg = (BubbleImageView) view.findViewById(R.id.image_message);
                    view.setTag(holder4);
                }else{
            ...
            case TO_USER_VOICE:
                ...
                if(view == null){
                    ...
                    holder5.sendFailImg = (ImageView) view.findViewById(R.id.mysend_fail_img);
                    view.setTag(holder5);
                }else{
    ...
    private void fromMsgUserLayout(final  FromUserMsgViewHolder holder, final ChatMessageBean tbub, final int position){
        holder.headicon.setBackgroundResource(R.mipmap.headicon1);
        if(position != 0){
    ...
    private void fromImgUserLayout(final  FromUserImageViewHolder holder, final ChatMessageBean tbub, final int position){
        ...
        if(isPicRefresh){
            ...
            if(hasLocal){
                holder.image_Msg.setLocalImageBitmap(ImageCheckoutUtil.getLocalBitmap(imageSrc), res);
            }else{
    ...
    private void toVoiceUserLayout(final ToUserVoiceViewHolder holder, final  ChatMessageBean tbub, final  int position) {
        ...
        holder.voice_group.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawable = (AnimationDrawable) holder.voice_anim.getBackground();
                drawable.start();
                final String voicePath = tbub.getUserVoiceUrl() == null ? "" : tbub.getUserVoiceUrl();
                if (voiceIsRead != null) {
                    voiceIsRead.voiceOnClick(position);
                }
                MediaManager.playSound(voicePath, new MediaPlayer.OnCompletionListener() {
